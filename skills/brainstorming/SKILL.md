...
allowed-tools:
  ...
  - Glob
  - Grep
description: Generate high-signal solution options for Laravel problems, with tradeoffs and a recommended path.
---

# Brainstorming (Laravel)

## Use when
- The task explicitly involves brainstorming in a Laravel codebase.
