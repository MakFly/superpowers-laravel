...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for inertia with focused implementation guidance and validation.
---

# Inertia (Laravel)

## Use when
- The task explicitly involves inertia in a Laravel codebase.
