...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for repository pattern with focused implementation guidance and validation.
---

# Repository Pattern (Laravel)

## Use when
- The task explicitly involves repository pattern in a Laravel codebase.
