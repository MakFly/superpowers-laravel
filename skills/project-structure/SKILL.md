...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for project structure with focused implementation guidance and validation.
---

# Project Structure (Laravel)

## Use when
- The task explicitly involves project structure in a Laravel codebase.
