...
allowed-tools:
  ...
  - Glob
  - Grep
description: Create a concise, dependency-aware implementation plan for Laravel work with validation checkpoints.
---

# Writing Plans (Laravel)

## Use when
- The task explicitly involves writing plans in a Laravel codebase.
