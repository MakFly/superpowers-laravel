...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for service providers with focused implementation guidance and validation.
---

# Service Providers (Laravel)

## Use when
- The task explicitly involves service providers in a Laravel codebase.
