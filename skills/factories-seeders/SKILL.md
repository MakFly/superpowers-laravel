...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for factories seeders with focused implementation guidance and validation.
---

# Factories Seeders (Laravel)

## Use when
- The task explicitly involves factories seeders in a Laravel codebase.
