...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for observer pattern with focused implementation guidance and validation.
---

# Observer Pattern (Laravel)

## Use when
- The task explicitly involves observer pattern in a Laravel codebase.
