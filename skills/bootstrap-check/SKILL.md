...
allowed-tools:
  ...
  - Glob
  - Grep
description: Inspect Laravel project bootstrap health and identify configuration/runtime blockers before implementation.
---

# Bootstrap Check (Laravel)

## Use when
- The task explicitly involves bootstrap check in a Laravel codebase.
