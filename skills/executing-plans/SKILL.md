...
allowed-tools:
  ...
  - Glob
  - Grep
description: Execute an approved plan step-by-step in a Laravel codebase with checkpoint validation after each step.
---

# Executing Plans (Laravel)

## Use when
- The task explicitly involves executing plans in a Laravel codebase.
