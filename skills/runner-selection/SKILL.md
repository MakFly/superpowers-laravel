...
allowed-tools:
  ...
  - Glob
  - Grep
description: Select the safest and fastest execution runner for this Laravel project (scripts, framework CLI, container, CI wrappers).
---

# Runner Selection (Laravel)

## Use when
- The task explicitly involves runner selection in a Laravel codebase.
