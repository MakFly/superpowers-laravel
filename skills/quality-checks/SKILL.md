...
allowed-tools:
  ...
  - Glob
  - Grep
description: Run Laravel quality gates (lint/static analysis/tests) and report actionable failures with remediation order.
---

# Quality Checks (Laravel)

## Use when
- The task explicitly involves quality checks in a Laravel codebase.
