...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Laravel practices for testing database with focused implementation guidance and validation.
---

# Testing Database (Laravel)

## Use when
- The task explicitly involves testing database in a Laravel codebase.
